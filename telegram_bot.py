...
from toobit_stage1_scanner import ToobitClient, run_scan
...
def _build_messages(scan_result: dict, market_key: str, market_title: str, quality_key: str) -> list[str]:
    ...
    if not results:
        return [f"⚠️ هیچ نمادی در {market_title} واجد شرایط نشد."]
...
async def scan_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    client: ToobitClient = context.bot_data["toobit_client"]
...
def main() -> None:
    ...
    # TODO: replace with your real, wired-up client (see ToobitClient
    # docstring in toobit_stage1_scanner.py). Left unimplemented here
    # on purpose — this bot file should not need to change when you
